...
const updateAccountDetails = asyncHandler(async(req, res)=>{
    const {fullName, email} = req.body   //any more things that need to be update we can added in this bracket
...
const updateUserAvatar = asyncHandler(async(req, res)=>{
    ...
    .status(200)
    .json(
        new ApiResponse(200, user, "avatar image upload succesfully")
    )
});
...
const updateUserCoverImage = asyncHandler(async(req, res)=>{
    ...
    .status(200)
    .json(
        new ApiResponse(200, user, "cover image upload succesfully")
    )
})
...
const getWatchHistory = asyncHandler(async(req, res)=>{
    ...
    .json(
        new ApiResponse(
            200, 
            user[0].watchHistory,
            "Watch history featched succesfully"
        )
    )
})
